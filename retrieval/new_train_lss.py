...
train_set = feature_data_lss.Feature_Data(seq_len=seq_len, is_top=is_top, front_only=front_only, scale=args.scale, seg=args.seg, lss=args.lss, num_cam=num_cam)
val_set = feature_data_lss.Feature_Data(seq_len=seq_len, training=False, is_top=is_top, front_only=front_only, scale=args.scale, viz=args.viz, seg=args.seg, lss=args.lss, num_cam=num_cam)
# print(val_set)
